 ...
 * @version "$Id$"
 */
public final class StringAutocompleteRenderer extends AbstractAutoCompleteTextRenderer<String> {
    ...
    public static <String> IAutoCompleteRenderer<String> instance() {
        return INSTANCE;
    }
